...
contract DeploySweepCCTPDepositAccountAction is Script {
    ...
    //
    // - with private key (on Anvil): forge script DeploySweepCCTPDepositAccountAction --fork-url http://localhost:8545 --private-key $ANVIL_DEPLOYER_PK
    // - with private key:            forge script DeploySweepCCTPDepositAccountAction --rpc-url $RPC_URL --private-key $DEPLOYER_PK
    // - with Ledger:                 forge script DeploySweepCCTPDepositAccountAction --rpc-url $RPC_URL --ledger
    // - with AWS:                    forge script DeploySweepCCTPDepositAccountAction --rpc-url $RPC_URL --aws

    // commands to deploy:
    //
    // - with private key (on Anvil): forge script DeploySweepCCTPDepositAccountAction --broadcast --fork-url http://localhost:8545 --private-key $ANVIL_DEPLOYER_PK
    // - with private key:            forge script DeploySweepCCTPDepositAccountAction --broadcast --rpc-url $RPC_URL --private-key $DEPLOYER_PK
    // - with Ledger:                 forge script DeploySweepCCTPDepositAccountAction --broadcast --rpc-url $RPC_URL --ledger
    // - with AWS:                    forge script DeploySweepCCTPDepositAccountAction --broadcast --rpc-url $RPC_URL --aws

...
contract EstimateSweepDepositAccountERC20GasConstant is InstructionForkTestContext {
    using InstructionLib for InstructionLib.Instruction;

    Treasury treasury;
    FeeTokenRegistry feeTokenRegistry;

    SweepDepositAccountERC20Action sweepAction;
    ...
    uint256 public constant SWEEP_DEPOSIT_ACCOUNT_ERC20_GAS_CONSTANT = 104_500;
    ...
    constructor() {
        ...
        sweepAction = new SweepDepositAccountERC20Action(
            address(feeTokenRegistry), address(treasury), SWEEP_DEPOSIT_ACCOUNT_ERC20_GAS_CONSTANT
        );
    ...
    function testFuzz_sweepDepositAccountERC20_gasConstant(
        uint256 salt,
        ...
        vm.deal(depositAccountAddress, type(uint248).max - 1);
        vm.prank(depositAccountAddress);
        IWETH9(SEPOLIA_WETH9).deposit{value: arguments.threshold + 1}();

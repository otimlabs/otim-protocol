...
contract EstimateTransferGasConstant is InstructionForkTestContext {
    ...
    constructor() {
        ...
        transferAction = new TransferAction(address(feeTokenRegistry), address(treasury), TRANSFER_GAS_CONSTANT);
    ...
    function testFuzz_transfer_gasConstant(
        uint256 salt,
        ...
        buildInstruction(salt, maxExecutions, address(transferAction), abi.encode(arguments));

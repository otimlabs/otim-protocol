...
contract EstimateSweepCCTPGasConstant is InstructionForkTestContext {
    using InstructionLib for InstructionLib.Instruction;

    Treasury treasury;
    FeeTokenRegistry feeTokenRegistry;

    SweepCCTPAction sweepCCTPAction;
    ...
    uint256 public constant SWEEP_CCTP_ACTION_GAS_CONSTANT = 104_500;
    ...
    constructor() {
        ...
        sweepCCTPAction = new SweepCCTPAction(
    ...
    // check that the SWEEP_CCTP_ACTION_GAS_CONSTANT doesn't result in an underpayment of the fee
    function testFuzz_sweepCCTP_gasConstant(
        uint256 salt,
        uint256 maxExecutions,
        ISweepCCTPAction.SweepCCTP memory arguments
    ) public {
        ...
        buildInstruction(salt, maxExecutions, address(sweepCCTPAction), abi.encode(arguments));

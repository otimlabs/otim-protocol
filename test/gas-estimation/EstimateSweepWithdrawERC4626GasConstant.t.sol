...
contract EstimateSweepWithdrawERC4626GasConstant is InstructionForkTestContext {
    ...
    uint256 public constant SWEEP_WITHDRAW_ERC4626_GAS_CONSTANT = 104_500;
    ...
    constructor() {
        ...
        sweepWithdrawERC4626Action = new SweepWithdrawERC4626Action(
            address(feeTokenRegistry), address(treasury), SWEEP_WITHDRAW_ERC4626_GAS_CONSTANT
        );

        actionManager.addAction(address(sweepWithdrawERC4626Action));
    }

    // check that the SWEEP_WITHDRAW_ERC4626_GAS_CONSTANT doesn't result in an underpayment of the fee
    function testFuzz_sweepWithdrawERC4626_gasConstant(
        uint256 salt,
        uint256 maxExecutions,
        ISweepWithdrawERC4626Action.SweepWithdrawERC4626 memory arguments
    ) public {
        ...
        vm.assume(arguments.threshold > 0 && arguments.threshold < whaleBalance);
        ...
        buildInstruction(salt, maxExecutions, address(sweepWithdrawERC4626Action), abi.encode(arguments));

...
bytes32 constant INSTRUCTION_TYPEHASH = keccak256(
    "Instruction(uint256 salt,uint256 maxExecutions,address action,SweepDepositERC4626 sweepDepositERC4626)SweepDepositERC4626(address vault,uint256 threshold,uint256 endBalance,uint256 minTotalAssets,Fee fee)Fee(address token,uint256 maxBaseFeePerGas,uint256 maxPriorityFeePerGas,uint256 executionFee)"
);

bytes32 constant ARGUMENTS_TYPEHASH = keccak256(
    "SweepDepositERC4626(address vault,uint256 threshold,uint256 endBalance,uint256 minTotalAssets,Fee fee)Fee(address token,uint256 maxBaseFeePerGas,uint256 maxPriorityFeePerGas,uint256 executionFee)"
);

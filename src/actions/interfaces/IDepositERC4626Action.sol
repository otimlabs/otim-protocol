...
bytes32 constant INSTRUCTION_TYPEHASH = keccak256(
    "Instruction(uint256 salt,uint256 maxExecutions,address action,DepositERC4626 depositERC4626)DepositERC4626(address vault,address recipient,uint256 value,uint256 minTotalAssets,Schedule schedule,Fee fee)Fee(address token,uint256 maxBaseFeePerGas,uint256 maxPriorityFeePerGas,uint256 executionFee)Schedule(uint256 startAt,uint256 startBy,uint256 interval,uint256 timeout)"
);

bytes32 constant ARGUMENTS_TYPEHASH = keccak256(
    "DepositERC4626(address vault,address recipient,uint256 value,uint256 minTotalAssets,Schedule schedule,Fee fee)Fee(address token,uint256 maxBaseFeePerGas,uint256 maxPriorityFeePerGas,uint256 executionFee)Schedule(uint256 startAt,uint256 startBy,uint256 interval,uint256 timeout)"
);
